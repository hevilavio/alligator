...
ADAFRUIT_IO_KEY      = '4ccea9ff41cc40b78da93a794ec5e4cc'
...
def connected(client):
    ...
    print('Connected to Adafruit IO!  Listening for {} changes...'.format(feed_name))
...
while True:
    ...
    print('Publishing {} to {}.'.format(value, feed_name))
